...
export default function Package() {
  ...
  return (
    <div className="max-w-xl">
      ...
      <p className="text-sm text-slate-400">Reja + hisobot + KTI. Bankka faqat rozilik bilan.</p>
      ...
      {res && (
        <div className="mt-4 bg-panel/60 border border-line rounded-2xl p-4 text-sm">
